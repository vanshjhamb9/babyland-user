...
class GetUserProvider extends ChangeNotifier {
  ...
  String get currentStageLabel {
    ...
    if (cType == "regular" || cType == "irregular") return "Pre-pregnancy";
    ...
    await repository.getUser().then((value) async {
      ...
      if (value.success == true) {
        ...
        if (user != null) {
          ...
          final stage = user.stage;
          pt("Syncing data. Backend stage: $stage");
          pt("Syncing data. Backend cycleType: ${user.cycleType}");
          ...
          if (stage == "pregnancy") {
            ...
            if (conceptionDate == null && userObj?.pregnancyTracker != null) {
              conceptionDate =
                  userObj!.pregnancyTracker!['pregnancyStartDate']?.toString() ??
