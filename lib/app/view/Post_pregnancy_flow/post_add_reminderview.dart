...
class PostAddReminderView extends StatefulWidget {
  const PostAddReminderView({super.key});

  @override
  State<PostAddReminderView> createState() => _PostAddReminderViewState();
}

class _PostAddReminderViewState extends State<PostAddReminderView> {

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<PostAppointmentController>(
        create: (context) => PostAppointmentController(),
        builder: (context, child) =>Consumer<PostAppointmentController>(
