...
class PostPreAppointmentView extends StatefulWidget {
  const PostPreAppointmentView({super.key});

  @override
  State<PostPreAppointmentView> createState() => _PostPreAppointmentViewState();
}

class _PostPreAppointmentViewState extends State<PostPreAppointmentView> {
  @override
  void initState() {
    super.initState();
    // Fetch appointment data when the screen loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<PostAppointmentController>(context, listen: false).getAppointmentApi();
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<PostAppointmentController>(
        ...
        return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    appointments.isEmpty
                        ? Expanded(child: CustomNoDataFound(isClr: false,heightBox: SBox(h: 50),))
                        : Expanded(
          ...
          bottomNavigationBar: AppContainer(
            ...
            child: Padding(
              ...
              child: Button(
                onTap: () async{
                  final result = await Navigator.pushNamed(context, AppRoutes.postAddReminderView);
                  if (result == true) {
                    Provider.of<PostAppointmentController>(context, listen: false).getAppointmentApi();
                  }
                },
