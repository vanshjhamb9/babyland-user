...
class PregnancySubScreen extends StatefulWidget {

  bool backButton;
   PregnancySubScreen({super.key,this.backButton=true});
  @override
  State<PregnancySubScreen> createState() => _PregnancySubScreenState();

}

class _PregnancySubScreenState extends State<PregnancySubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        centerTitle: true,isLeading: widget.backButton == true ? true : false,
  ...
  return SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 6),
        // Unlock premium features text placeholder
        Shimmer.fromColors(
          baseColor: Colors.grey.shade300,
          highlightColor: Colors.grey.shade100,
          child: Container(
