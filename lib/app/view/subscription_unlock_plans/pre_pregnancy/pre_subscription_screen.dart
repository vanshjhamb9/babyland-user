...
class PreSubscriptionScreen extends StatefulWidget {

  const PreSubscriptionScreen({super.key});
  @override
  State<PreSubscriptionScreen> createState() => _PreSubscriptionScreenState();

}

class _PreSubscriptionScreenState extends State<PreSubscriptionScreen> {
               ...
               ListView.separated(
                 ...
                 onTap: (){
                   setState(() {
                     ...
                     print("provider.selectedPlanID ${plans?.name}");
                   });
