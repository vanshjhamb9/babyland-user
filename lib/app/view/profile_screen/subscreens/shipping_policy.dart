...
class _ShippingPolicyScreenState extends State<ShippingPolicyScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<PoliciesProvider>().privacyPolicyApi('shipping');
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: Text("Shipping Policy",style: AppFontStyle.text_20_400(fontFamily: AppFontFamily.gilroyMedium)),centerTitle: true,),
