...
class _RefundPolicyScreenState extends State<RefundPolicyScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<PoliciesProvider>().privacyPolicyApi('return');
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: Text("Refund Policy",style: AppFontStyle.text_20_400(fontFamily: AppFontFamily.gilroyMedium)),centerTitle: true,),
