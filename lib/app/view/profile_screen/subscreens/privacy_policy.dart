...
class _PrivacyPolicyViewState extends State<PrivacyPolicyView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<PoliciesProvider>().privacyPolicyApi("privacy");
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: Text("Privacy Policy",style: AppFontStyle.text_20_400(fontFamily: AppFontFamily.gilroyMedium)),centerTitle: true,),
