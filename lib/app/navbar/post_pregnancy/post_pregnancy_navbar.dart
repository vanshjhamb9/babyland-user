...
class PostPregnancyNavbarView extends StatefulWidget {
  const PostPregnancyNavbarView({super.key});

  @override
  State<PostPregnancyNavbarView> createState() => _PostPregnancyNavbarViewState();
}
...
class _PostPregnancyNavbarViewState extends State<PostPregnancyNavbarView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:Consumer<PostPregnancyNavBarProvider>(
  ...
  Widget _buildProfileItem(int index, PostPregnancyNavBarProvider provider) {
    final isSelected = provider.selectedIndex == index;
    return InkWell(
      splashColor: AppColors.transparent,
      highlightColor: AppColors.transparent,
